...
- **Stats overview**: Jobs, users, companies, invoices, payments, and paid revenue totals (EUR-only for billing).
- **Charts**: 14-day trends for new jobs and payment revenue (EUR-only).
