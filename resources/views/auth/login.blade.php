<x-layouts.pixel title="{{ __('main.login') }}">
    <div class="mx-auto max-w-md">
        <div class="pixel-frame p-6">
            <div class="mb-6">
                <div class="text-xs uppercase tracking-[0.2em] text-slate-500">365jobs</div>
                <h1 class="mt-2 text-2xl font-bold">{{ __('main.login') }}</h1>

                <p class="mt-2 text-slate-600">{{ __('main.login_subtitle') }}</p>

                <p class="mt-2 text-slate-600">{{ __('main.login_info') }}</p>
            </div>
            ...
            <div class="mt-6 flex items-center justify-between text-xs uppercase tracking-[0.2em] text-slate-600">
                <a class="hover:text-blue-700" href="{{ route('frontend.register') }}">{{ __('main.register_title') }}</a>
                <a class="hover:text-blue-700" href="{{ url('/') }}">{{ __('main.home') }}</a>
            </div>
        </div>
    </div>
</x-layouts.pixel>
