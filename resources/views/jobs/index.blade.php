            ...
            <div class="flex flex-col gap-4 lg:col-span-3">
                @forelse ($jobs as $job)
                    @php
                        ...
                        $companyUrl = $company ? route('company.show', $company) : null;
                        ...
                        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                            <div class="space-y-2">
                                ...
                                @if ($company && $companyUrl)
                                    <a class="text-sm text-slate-600 hover:underline" href="{{ $companyUrl }}">{{ $company->legal_name }}</a>
                                @elseif ($company)
